...
handle error conditions in “To panic! or Not to panic!” on page 175. Next,
...
Recall from “Handling Potential Failure with Result” on page 17 that the
...
`read`_username_from_file` will call `from` and convert the error types without
...
Trait Objects That Allow for Values of Different Types” on page 379. For now,
