...
fn main() {
  ...
  9 } else {
      a println!("Using blue as the background color");
    }
}
```
...
these conditions apply [9], the background color is blue [a].
...
`_` or `..`, as you’ll see in “Ignoring Values in a Pattern” on page 411. If
