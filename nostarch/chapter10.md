...
1. 1.Identify duplicate code.
1. 2.Extract the duplicate code into the body of the function, and specify the
inputs and return values of that code in the function signature.
1. 3.Update the two instances of duplicated code to call the function instead.
...
`returns`_summarizable` function returns some type that implements the
...
for Values of Different Types” on page 379.
...
Methods” on page 97 that `Self` is a type alias for the type of the `impl`
...
One detail we didn’t discuss in “References and Borrowing” on page 71 is that
...
ownership of its parameters. Refer to “String Slices as Parameters” on page 82
...
*https://doc.rust-lang.org/reference/trait**-bounds.html*. But next, you’ll
